...
class OngOffActivity : DebugActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Prefs.getString("logado") == "sim") {
            setContentView(R.layout.activity_tela_ong)
        } else {
            setContentView(R.layout.activity_tela_ong_segunda)
        }
        ...
        supportActionBar?.title="Sobre ONGs"
